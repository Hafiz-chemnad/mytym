  ...
  Future<void> _register() async {
    if (_nameController.text.trim().isEmpty ||
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text(
            "Name, WABA ID, Phone ID, and Token are absolutely required!",
          ),
    ...
    try {
      final url = Uri.parse('${ApiService().baseUrl}/api/restaurants');
      ...
      final Map<String, dynamic> payload = {
        ...
        "razorpayKeyId": _razorpayIdController.text.trim().isEmpty
            ? "string"
            : _razorpayIdController.text.trim(),
        "razorpayKeySecret": _razorpaySecretController.text.trim().isEmpty
            ? "string"
            : _razorpaySecretController.text.trim(),
        "razorpayWebhookSecret": _razorpayWebhookController.text.trim().isEmpty
            ? "string"
            : _razorpayWebhookController.text.trim(),
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            const Text(
              "Your restaurant has been created. Save this ID to login:",
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 4),
              const Text(
                "Configure the database payload required by the backend API.",
                style: TextStyle(color: Color(0xFF6B7280), fontSize: 14),
              ),
              const SizedBox(height: 32),
              ...
              _buildContentCard(
                ...
                subtitle:
                    "Configure how the WhatsApp bot interacts with customers",
                ...
                content: Column(
                  children: [
                    ...
                    _buildDropdownField(
                      ...
                      const [
                        ...
                        DropdownMenuItem(
                          value: "ORDER_TYPE",
                          child: Text(
                            "Order Type Flow (Ask Delivery/Takeaway)",
                          ),
                        ),
                      ],
                    ...
                    if (_primaryFlow == "ORDER_TYPE")
                      _buildDropdownField(
                        "Delivery Flow Type (Conditional)",
                        _deliveryFlow,
                        const [
                          DropdownMenuItem(
                            value: "LOCATION_FIRST",
