...
class _MarketingScreenState extends State<MarketingScreen> {
  ...
  // 🔑 GlobalKeys let us call public methods on child tab states directly
  final GlobalKey<ContactsTabState> _contactsKey =
      GlobalKey<ContactsTabState>();
  final GlobalKey<LabelsTabState> _labelsKey = GlobalKey<LabelsTabState>();
  final GlobalKey<CampaignsTabState> _campaignsKey =
      GlobalKey<CampaignsTabState>();
  ...
  void _onTabTap(int index) {
    ...
    // 🔥 FIX: Refresh the tab we're switching TO so it always has fresh data.
    // This is what makes new labels appear in the Contacts apply-label dialog.
    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  "Manage your WhatsApp contacts, automated labels, and broadcast campaigns.",
          ...
          // Tab switching calls loadData() on the destination tab via GlobalKey
          // so data is always fresh without rebuilding the whole widget.
          Expanded(
            child: IndexedStack(
    ...
    return InkWell(
      ...
      child: Container(
        ...
        child: Text(
          title,
          style: TextStyle(
            color: isActive ? primaryTeal : textMuted,
