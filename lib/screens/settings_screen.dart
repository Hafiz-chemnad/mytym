...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  Future<void> _saveSettingsToBackend(Map<String, dynamic> updatedFields, VoidCallback closeEditMode) async {
    ...
    bool success = await _apiService.updateRestaurantSettings(widget.restaurantId, updatedFields);
    ...
    if (success) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text("Failed to save changes. Check backend logs."), backgroundColor: Colors.redAccent));
    }
  }
            ...
            Row(
              children: [
                Container(
                  ...
                  child: const Icon(Icons.pin_drop_outlined, size: 18, color: Color(0xFF111827)),
                ),
            ...
            _buildInputGrid([
              _buildDropdownField(
                ...
                items: const [
                  ...
                  DropdownMenuItem(value: "TAKEAWAY", child: Text("Takeaway Only")),
                  DropdownMenuItem(value: "BOTH", child: Text("Both (Delivery & Takeaway)")),
                ],
                isEditing: _isEditingOps,
              ...
              _buildDropdownField(
                ...
                items: const [
                  ...
                  DropdownMenuItem(value: "ONLINE", child: Text("Online Payment Only")),
                  DropdownMenuItem(value: "BOTH", child: Text("Both (COD & Online)")),
                ],
                isEditing: _isEditingOps,
          ...
          children: [
            _buildInputGrid([
              _buildDropdownField(
                ...
                value: _primaryFlow,
                items: const [
                  DropdownMenuItem(value: "LOCATION_FIRST", child: Text("Location First Flow")),
                  DropdownMenuItem(value: "LOCATION_LAST", child: Text("Location Last Flow")),
                  DropdownMenuItem(value: "ORDER_TYPE", child: Text("Order Type Flow (Ask Delivery/Takeaway)")),
                ],
                isEditing: _isEditingBot,
                onChanged: (val) {
                  setState(() {
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                Row(
                  children: [
                    const Icon(Icons.settings_outlined, color: Color(0xFF111827), size: 20),
              ...
              children: [
                ...
                if (!isEditing)
                  ElevatedButton(
                    ...
                    onPressed: onEdit,
                    child: const Text("Edit Settings", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 13)),
                  )
                else
                  Row(
                    children: [
  ...
  Widget _buildInputGrid(List<Widget> children) {
    return LayoutBuilder(builder: (context, constraints) {
      return Wrap(
        spacing: 24, 
        runSpacing: 24, 
        children: children.map((w) => SizedBox(width: constraints.maxWidth > 800 ? (constraints.maxWidth / 2) - 12 : constraints.maxWidth, child: w)).toList(),
      );
    });
  }
      ...
      children: [
        ...
        TextField(
          ...
          style: TextStyle(
            ...
            fontWeight: isEditing ? FontWeight.w400 : FontWeight.w600, // Bold when reading
          ),
          decoration: InputDecoration(
            ...
            enabledBorder: OutlineInputBorder(
              borderRadius: BorderRadius.circular(6),
              borderSide: isEditing ? const BorderSide(color: Color(0xFFD1D5DB)) : BorderSide.none, 
            ),
